                    ...
                    children: [
                     GestureDetector(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            color: selected==1?Colors.blueAccent:Colors.transparent,
                            borderRadius: BorderRadius.circular(20.0), // Set rounded corner radius
                            border: Border.all(
                              color: selected==1?Colors.transparent:Colors.grey, // Set border color
                              width: 1.0, // Set border width
                            ),
                          ),
                          child: Padding(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            ...
                            title: Text('John Doe',style: TextStyle(color: Colors.white),), // Add title text
                            trailing: Icon(Icons.arrow_forward,color: Colors.white,), // Add trailing icon
                            onTap: () {
